...
alias al = nvim ~/.config/zsh/alias.sh
alias fu = nvim ~/.config/zsh/functions.sh
...
# WIFI
alias wr = nmcli radio wifi off and sleep 5 and nmcli radio wifi on
...
alias grm = git fetch and git rebase origin/main
